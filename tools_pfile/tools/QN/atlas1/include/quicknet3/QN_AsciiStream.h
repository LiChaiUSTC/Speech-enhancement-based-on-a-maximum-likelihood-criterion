...
// $Header: /u/drspeech/repos/quicknet2/QN_AsciiStream.h,v 1.4 2006/01/27 02:30:00 davidj Exp $
...
public:
    ...
    void clear(void);
    int readPhset(char *filename);
    int writePhset(char *filename);
    int lookup(char *tok);	// returns -1 if token not found
