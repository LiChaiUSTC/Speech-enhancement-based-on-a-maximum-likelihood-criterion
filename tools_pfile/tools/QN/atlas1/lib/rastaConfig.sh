...
RASTA_BUILD_LIB_SPEC='-L/home/dujun/TANDEM/tools/QN/rasta -lrasta '
RASTA_INSTALL_LIB_SPEC='-L/home/dujun/TANDEM/tools/QN/atlas1/lib -lrasta '
RASTA_LIB_SPEC=${RASTA_INSTALL_LIB_SPEC}

# Location of the installed include headers directory
RASTA_BUILD_INC_SPEC='-I/home/dujun/TANDEM/tools/QN/rasta '
RASTA_INSTALL_INC_SPEC='-I/home/dujun/TANDEM/tools/QN/atlas1/include '
RASTA_INC_SPEC=${RASTA_INSTALL_INC_SPEC}

# Where to find, e.g., the rasta testsuite
RASTA_SRC_DIR='/home/dujun/TANDEM/tools/QN/rasta'
